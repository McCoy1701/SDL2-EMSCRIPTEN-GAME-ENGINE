...
$(OBJ_DIR)/tiles.o: $(GAME_DIR)/tiles/tiles.c
	$(ECC) $< -c -o $@

$(OBJ_DIR)/generateWorld.o: $(GAME_DIR)/world/generateWorld.c
	$(ECC) $< -c -o $@

$(OBJ_DIR)/world.o: $(GAME_DIR)/world/world.c
	$(ECC) $< -c -o $@

$(OBJ_DIR)/globals.o: $(GAME_DIR)/globals/global.c
	$(ECC) $< -c -o $@
